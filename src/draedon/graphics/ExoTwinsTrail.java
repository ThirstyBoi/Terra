...
public class ExoTwinsTrail extends Trail{
    private final FloatSeq points;
    private float lastX = -1, lastY = -1, lastAngle = -1, counter = 0f, lastW = 0f;

    public ExoTwinsTrail(int length){
        super(length);
        points = new FloatSeq(length * 6); //x, y, w, dx, dy, drag
    }

    public ExoTwinsTrail copy(){
        ExoTwinsTrail out = new ExoTwinsTrail(length);
